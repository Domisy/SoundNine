 ...
 * of this value object you may modify the generated sub-class of this class - GetTrackResponse.as.
 */
...
[ExcludeClass]
public class _Super_GetTrackResponse extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _GetTrackResponseEntityMetadata;
    ...
    private var _internal_artwork_url : String;
    ...
    public function _Super_GetTrackResponse()
    {
        _model = new _GetTrackResponseEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get artwork_url() : String
    {
    ...
    public function set artwork_url(value:String) : void
    {
        var oldValue:String = _internal_artwork_url;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _GetTrackResponseEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _GetTrackResponseEntityMetadata) : void
    {
        var oldValue : _GetTrackResponseEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfArtwork_url : String;
